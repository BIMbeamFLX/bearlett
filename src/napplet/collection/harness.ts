 ...
 * not from the collection's own code: HKDF-SHA256 over the seed, salted with
 * `bearlett:nutft:wallet` and bound to the edition id, as 24 words.
 */
